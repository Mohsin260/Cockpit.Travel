              ...
              <div className="flex gap-[7px] mb-[25px]">
                {tabLabels.map((tab) => (
                  <button
                    ...
                    className={`inline-flex items-center justify-center px-[26px] py-[10px] text-[16px] font-semibold rounded-[5px] transition-all duration-300 whitespace-nowrap ${activeTab === tab.key
