      ...
      <div className="nerio-container">
        ...
        <div className="flex gap-6 max-[1024px]:flex-col max-[1024px]:gap-5">
          <div className="flex-1 min-w-0 relative rounded-xl overflow-hidden group" style={getCssVars(CARD_STYLES["article-hero"])}>
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 md:p-8">
                ...
                <ul className="flex flex-wrap items-center gap-x-3 gap-y-1 mt-3 text-[13px] text-white/70">
                  <li className="flex items-center gap-1">
                    ...
                    <span>{t("common.by")} <span className="hover:text-[var(--primaryColor)] transition-colors cursor-pointer">{featured.authorName}</span></span>
                  </li>
                  <li className="flex items-center gap-1">
                    ...
                    <span>{featured.views} {t("common.views")}</span>
                  </li>
                  <li className="flex items-center gap-1">
                ...
                <div className="flex-1 min-w-0 flex flex-col justify-center gap-1">
                  ...
                  <ul className="flex items-center gap-2 text-[11px] text-[var(--bodyColor)]">
                    <li className="flex items-center gap-1">
                      ...
                      <span>{t("common.by")} <span className="text-[var(--bodyColor)] hover:text-[var(--primaryColor)] transition-colors">{post.authorName}</span></span>
                    </li>
                    <li className="flex items-center gap-1">
            ...
            <InFeedNativeAd position="in-feed-3" cardStyle="latest-articles" className="bg-white rounded-lg p-3 border border-gray-100" />
          </div>
        </div>
        ...
        <div className="news-carousel-wrap mt-8">
          ...
          >
            ...
            <SwiperSlide className="h-auto">
              <InFeedNativeAd position="in-feed-4" cardStyle="popular-articles" className="h-full" />
            </SwiperSlide>
          </Swiper>
        </div>
      </div>
