        ...
        <div className="inner-pills-wrapper flex flex-wrap items-center">
          {tags.map((tag) => (
            <a
              key={tag}
              href="#"
              className="inner-pill-item inline-block px-[15px] py-[10px] mx-[5px] text-[14px] font-normal text-body bg-white border border-border rounded-[5px] hover:text-primary transition-all duration-300"
            >
              {tag}
            </a>
          ))}
        ...
        <div className="rs-social-share flex items-center gap-[10px]">
          {socials.map((social) => (
            <a
              ...
              className="social-network flex items-center justify-center w-[30px] h-[30px] bg-white text-title hover:text-primary transition-all duration-300"
            >
              <svg viewBox="0 0 512 512" className="w-[14px] h-[14px]" style={{ fill: "currentColor" }}>
                <path d={social.icon} />
              </svg>
            </a>
          ))}
